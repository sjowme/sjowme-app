...
(function(UI) {
    ...
    UI.component('slideshowSj', {
        ...
        boot() {
            ...
            UI.ready((context) => {
                ...
                UI.$('[data-uk-slideshow-sj]', context).each(function() {

                    var slideshowSj = UI.$(this);

                    if (!slideshowSj.data("slideshowSj")) {
                        UI.slideshowSj(slideshowSj, UI.Utils.options(slideshowSj.attr("data-uk-slideshow-sj")));
                    }
                });
            });
        },
        ...
        init() {
            ...
            UI.$win.on("resize load", UI.Utils.debounce(() => {
                this.resize();
            ...
            this.container.on({
                mouseenter: () => { if (this.options.pauseOnHover) {this.hovering = true;}  },
        ...
        update(resize) {
            ...
            this.slides.each(function(index) {
                ...
                var media = slide.children('img,video,iframe,div.yt-base').eq(0), type = 'html';
        ...
        show(index, direction, animation_type) {
            ...
            animation_type = animation_type || this.options.animation;
            ...
            var $this        = this,
                ...
                animation    = Animations[animation_type] ? animation_type : 'fade',
    ...
    UI.slideshowSj.animations = Animations;
